...
angular.module('NodeForm.templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("../public/modules/forms/views/directiveViews/form/edit-form.client.view.html",
    ...
    "\n" +
    "                    <accordion-group data-ng-repeat=\"field in myform.form_fields track by $index\" is-open=accordion[$index].isOpen on-finish-render=editFormFields ng-if=!field.deletePreserved>\n" +
    "\n" +
    "                        <accordion-heading>\n" +
    "\n" +
    "                            <div class=handle>\n" +
    ...
    "                    <div class=\"panel panel-default\" ng-repeat=\"field in myform.form_fields track by $index\" ng-if=!field.deletePreserved>\n" +
